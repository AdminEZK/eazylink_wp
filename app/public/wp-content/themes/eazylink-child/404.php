            ...
            <div class="container">
                <div class="error-404-content">
                    ...
                    <div class="error-404-illustration">
                        ...
                        <div class="error-decoration error-decoration-3"></div>
                    </div>
                    
                    <!-- Contenu texte -->
                    <div class="error-404-text">
                        <h1 class="error-404-title">Oups ! Page introuvable</h1>
                    ...
                    <div class="error-404-suggestions">
                        <h3>Ou explorez nos pages populaires :</h3>
                        <div class="suggestions-grid">
                            <a href="<?php echo esc_url(home_url('/nos-solutions-ia/')); ?>" class="suggestion-card">
                            ...
                            <a href="<?php echo esc_url(home_url('/experts-ia/')); ?>" class="suggestion-card">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <a href="<?php echo esc_url(home_url('/a-propos/')); ?>" class="suggestion-card">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
